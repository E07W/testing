...
client.on("message", message => {
  ...
  if (command === "about") {
    let embed = new Discord.MessageEmbed()
      .setAuthor("Revan Assistant")
      .setTitle("Assistant Help")
      .addField("Creators", ` <@489911410466488323> , <@628242038948888577>`)
      .addField("Team" , "@Flow & Lazer™")
      .addField("Commands", `\`1 General Commands , 5 Security Commands , 10 Protection Commands\``)
      .addField("Version", `\`Special V 1.1\``)
